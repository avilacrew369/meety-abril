...
export default async function ProfilePage({ params }: PageProps<'/profiles/[id]'>) {
    ...
    const profile = await profileService.getProfileDetails(id)
    ...
    return (
        <>
            ...
            <section className="max-w-7xl mx-auto mt-10 space-y-5 px-5 lg:p-0 ">
                <Heading level={2} className="text-center">Comunidades de {profile.name}</Heading>
            ...
            <section className="max-w-7xl mx-auto mt-10 space-y-5 px-5 lg:px-0 pb-20">
                <Heading level={2} className="text-center">Proximos Meeties Organizados por {profile.name}</Heading>
